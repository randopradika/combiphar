...
use App\Filament\Resources\InvestorPresentationResource\Pages;
...
class InvestorPresentationResource extends Resource
{
    protected static ?string $model = InvestorDocument::class;

    protected static ?string $slug = 'investor-presentation';

    protected static ?string $navigationGroup = 'Investor';

    protected static ?string $navigationLabel = 'Presentasi Perusahaan';
    ...
    {
        return parent::getEloquentQuery()->where('category', 'presentation');
    }

    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('category')->default('presentation'),
    ...
    {
        return ['index' => Pages\ManageInvestorPresentation::route('/')];
    }
}
