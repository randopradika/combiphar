...
use App\Filament\Resources\InvestorSustainabilityResource\Pages;
...
class InvestorSustainabilityResource extends Resource
{
    protected static ?string $model = InvestorDocument::class;

    protected static ?string $slug = 'investor-sustainability';

    protected static ?string $navigationGroup = 'Investor';

    protected static ?string $navigationLabel = 'Keberlanjutan';
    ...
    {
        return parent::getEloquentQuery()->where('category', 'sustainability');
    }

    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('category')->default('sustainability'),
    ...
    {
        return ['index' => Pages\ManageInvestorSustainability::route('/')];
    }
}
