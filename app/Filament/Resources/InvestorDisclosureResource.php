...
use App\Filament\Resources\InvestorDisclosureResource\Pages;
...
class InvestorDisclosureResource extends Resource
{
    protected static ?string $model = InvestorDocument::class;

    protected static ?string $slug = 'investor-disclosure';

    protected static ?string $navigationGroup = 'Investor';

    protected static ?string $navigationLabel = 'Keterbukaan Informasi';
    ...
    {
        return parent::getEloquentQuery()->where('category', 'disclosure');
    }

    public static function form(Form $form): Form
    {
        return $form->schema([
            Forms\Components\Hidden::make('category')->default('disclosure'),
    ...
    {
        return ['index' => Pages\ManageInvestorDisclosure::route('/')];
    }
}
